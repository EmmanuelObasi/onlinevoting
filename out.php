...
<div id="page">
    ...
    <div id="container">
        <table width="420" align="center">
            <form name="fmNames" id="fmNames" method="post" action="out.php" onSubmit="return positionValidate(this)">
                <tr>
                    ...
                    <h5>To see the election results, click the drop down list and select the position for which you cast your vote and click on see results</h5><br>
                    <td><input type="submit" name="Submit" value="See Results" /></td><br>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
